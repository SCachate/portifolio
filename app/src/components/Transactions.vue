...
<template>
  <!-- h-screen + overflow-hidden aqui é vital para matar a barra lateral do navegador -->
  <div class="flex flex-col bg-[#0b0f17] text-slate-300 font-sans p-6 h-screen overflow-hidden">
    ...
    <!-- O segredo está no 'min-h-0' e 'flex-1' para o grid respeitar o limite do pai -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-[1600px] mx-auto w-full flex-1 min-h-0">
      ...
      <section class="lg:col-span-4 flex flex-col min-h-0">
        <!-- overflow-y-auto apenas no card interno se o form for grande -->
        <div class="bg-[#161b26] rounded-xl border border-white/5 p-6 space-y-6 flex flex-col overflow-y-auto custom-scrollbar shadow-xl h-full">
          ...
          <div class="overflow-auto custom-scrollbar flex-1">
            <table class="w-full text-left border-separate border-spacing-0 min-w-[800px]">
              <thead class="sticky top-0 z-20">
                <tr class="text-[10px] font-black text-slate-500 uppercase tracking-[0.15em] bg-[#1b2230]">
                  <th class="p-4 border-b border-white/5">Data</th>
                  <th class="p-4 border-b border-white/5">Ativo / Descrição</th>
                  <th class="p-4 border-b border-white/5">Qtd.</th>
                  <th class="p-4 border-b border-white/5">Preço Unit.</th>
                  <th class="p-4 border-b border-white/5 text-right">Total</th>
                </tr>
              </thead>
