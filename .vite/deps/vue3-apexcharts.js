...
// app/node_modules/apexcharts/dist/apexcharts.esm.js
...
var DateTime = class {
  ...
  formatDate(date, format) {
    ...
    const m2 = utc ? date.getUTCMinutes() : date.getMinutes();
...
var Defaults = class {
  ...
  _getBoxTooltip(w, seriesIndex, dataPointIndex, labels, chartType) {
    ...
    const m2 = w.candleData.seriesCandleM[seriesIndex][dataPointIndex];
...
var BoxCandleStick = class extends Bar {
  ...
  getOHLCValue(i, j) {
    ...
    const m2 = getCandleVal(w.candleData.seriesCandleM);
...
// app/node_modules/vue3-apexcharts/dist/vue3-apexcharts.js
var A = [
  "animationEnd",
  "beforeMount",
  "mounted",
